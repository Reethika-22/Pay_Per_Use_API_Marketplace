...
By default the template creates a single `HelloWorld` contract under pay_per_call_contracts folder in the `smart_contracts` directory. To add a new contract:
